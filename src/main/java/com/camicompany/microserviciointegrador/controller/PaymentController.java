...
public class PaymentController {
  ...
  @ApiResponses({
    ...
    @ApiResponse(
        responseCode = "500",
        description =
            "Internal server error: an unexpected error occurred in the integrator service",
        content = @Content),
    @ApiResponse(
        responseCode = "503",
        description = "Service unavailable: Helipagos is unreachable",
        content = @Content)
  })
  @PostMapping
  ...
  @ApiResponses({
    ...
    @ApiResponse(
        responseCode = "409",
        description = "Cannot cancel payment in the current state",
        content = @Content),
    @ApiResponse(
        responseCode = "503",
        description = "Service unavailable: Helipagos is unreachable",
  ...
  @ApiResponses({
    ...
    @ApiResponse(
        responseCode = "400",
        description = "Invalid API Key or invalid data",
        content = @Content)
  })
  @PostMapping("/webhook")
